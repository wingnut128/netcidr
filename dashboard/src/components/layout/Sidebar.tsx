...
export function Sidebar({ ipamEnabled, mobileOpen, onClose }: SidebarProps) {
  ...
  return (
    <>
      ...
      <nav
        className={`fixed left-0 top-0 h-full w-48 bg-surface border-r border-border flex flex-col z-50 transform transition-transform duration-200 ease-out ${
