...
- *(dashboard)* make navigation auth-aware ([#367](https://github.com/wingnut128/netcidr/pull/367))
...
- *(docker)* refresh pinned image digests ([#291](https://github.com/wingnut128/netcidr/pull/291))
- *(deps)* bump the cargo-minor-and-patch group with 2 updates ([#295](https://github.com/wingnut128/netcidr/pull/295))
- *(deps)* bump serde-saphyr from 0.0.28 to 0.0.29 ([#296](https://github.com/wingnut128/netcidr/pull/296))
